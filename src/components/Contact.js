    ...
    return (
        <div className="font-mono lg:px-40 px-10 lg:py-12 py-2 lg:pb-0 bg-[#09192F] text-slate-400 w-full" id="project">
            <div className="min-[1023px]:hidden">
                <div className="flex">
                    <div>
                        <h2 className="text-[32px] w-[125px] text-slate-100 font-bold pb-2">Contact</h2>
                    </div>
                    <div className="bg-slate-400 w-full h-[2px] mt-6 ml-2"></div>
                </div>
                <p>Kotak masuk saya selalu terbuka. Apakah Anda memiliki pertanyaan atau hanya ingin menyapa, saya akan mencoba yang terbaik untuk menghubungi Anda kembali!</p>
